...
<head>
    ...
    <link rel="stylesheet" href="{{asset("css/cliente/mantenimiento/style.css")}}">

</head>
<body>
    <nav class="navbar navbar-light nav-seguimiento">
        <div class="container">
          <a class="navbar-brand" href="#" >
            <img src="/images/asit.png" alt="" width="80" height="40">
          </a>
          <h1 class="titulo">Seguimiento de equipo en mantenimiento</h1>
          <form action="{{route("salircliente")}}" method="POST" class="d-flex">

            <button class="btn-nav" >Salir</button>
          </form>
        </div>
      </nav>
    ...
    <div class="d-flex d-flex justify-content-center vh-100">
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card" style="width: 15rem; height:41.5vw" >
                <div id="img">
                    <img id="imgexits" class="card-img-top" src="{{$mantenimiento->product->imagePrduct[0]->img->url_public}}" alt="Card image cap"  width="200" height="340">
                </div>
