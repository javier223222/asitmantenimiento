...
<body>
  <nav style="background-color: #1F1F29" class="navbar navbar-expand-lg">
    <div class="container">
      ...
      <div class="mx-auto">
        <h1 class="navbar-text title">Equipos del técnico</h1>
      </div>
  ...
  <div id="noresult">
    <div class="contenedor-botones-busqueda">
      <a href={{ route('mantenimientoTecnicoforspecific', ['id' => $admin]) }} class="btn btn-primary">Ver todos los
        equipos</a>
      <a href={{ route('mantenimientoTecnicoforspecific', ['id' => $admin, 'finish' => 1, 'all' => 0]) }}
        class="btn btn-primary">Ver los equipos terminados</a>
      <a href={{ route('mantenimientoTecnicoforspecific', ['id' => $admin, 'finish' => 0, 'all' => 1]) }}
        class="btn btn-primary">Ver los equipos en proceso</a>
    </div>
      ...
      @foreach ($mantenimientos as $item)
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card" style="width: 16rem; height:48vw;">
              ...
              <div class="card-body">
                <a href={{ route('chatcliente', ['id' => $item->foliId]) }}
                  class="btn btn-primary">Comentar</a>
