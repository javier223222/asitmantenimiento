...
<body>
  <div class="containeradd">
    <nav class="navbar">
      ...
      <button class="btn btn-light ms-1 ">Agregar</button>
    ...
    <form action="{{ route('addMantenimiento') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <textarea name="descripcionequi" class="form-control" id="descripciomdelequipo" rows="2" required></textarea>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" name="descripcionproblema" id="descripcionprobequipo" rows="2" required></textarea>
        </div>
