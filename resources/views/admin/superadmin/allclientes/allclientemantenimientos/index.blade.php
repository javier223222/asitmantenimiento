...
<head>
  ...
  <title>Mantenimientos del cliente</title>
</head>
...
<body>
  <nav style="background-color: #1F1F29" class="navbar navbar-expand-lg">
    <div class="container">
      ...
      <div class="mx-auto">
        <h1 class="navbar-text title">Todos los equipos del cliente</h1>
      </div>
  ...
  <div id="noresult">
    <div class="d-flex gap-2 px-4 py-2 ">
      <a href={{ route('allmantenimientosclientes', ['id' => $id]) }} class="btn btn-light">Ver todos los equipos</a>
      <a href={{ route('allmantenimientosclientes', ['id' => $id, 'finish' => 1, 'all' => 0]) }}
        class="btn btn-light">Ver los
        equipos terminados</a>
      <a href={{ route('allmantenimientosclientes', ['id' => $id, 'finish' => 0, 'all' => 1]) }}
        class="btn btn-light">Ver los
        equipos en proceso</a>
    </div>
  </div>
  ...
  <input id="id" type="text" value="{{ $id }}" style="visibility: hidden">
          ...
          @foreach ($mantenimientos as $item)
            <div class="col-6 col-md-6">
              <div class="card" style="width: 17vw;">
                <img class="card-img-top" src="{{ $item->product->imagePrduct[0]->img->url_public }}"
                  alt="Card image cap">
                <div class="card-body">
  ...
  @vite('resources/js/searchmantenimientocliente.js')
