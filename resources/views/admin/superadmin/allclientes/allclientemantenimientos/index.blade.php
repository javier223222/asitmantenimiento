...
<head>
    ...
    <link rel="stylesheet" href={{ asset('css/admin/tecnico/allclientes/style.css') }}>
...
<body>
    ...
    <a class="navbar-brand" href={{route("superadmin")}}>
          <img src={{asset("images/asit.png")}} width="90" height="50" alt="">
        </a>
      <div class="mx-auto">
      ...
      <div class="contenedor-botones-busqueda">
        <a href={{route("allmantenimientosclientes",["id"=>$id])}} class="btn btn-primary">Ver todos los equipos</a>
        <a href={{route("allmantenimientosclientes",["id"=>$id,"finish"=>1,"all"=>0])}} class="btn btn-primary">Ver los equipos terminados</a>
        <a href={{route("allmantenimientosclientes",["id"=>$id,"finish"=>0,"all"=>1])}} class="btn btn-primary">Ver los equipos en proceso</a>
      </div>   
      </div>
