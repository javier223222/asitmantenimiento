  ...
  <div class="containeradd">
    ...
    <form action={{ route('newTecnico') }} method="POST">
      ...
      <div class="mb-3">
        ...
        <input placeholder="Agreagr Usuario" type="text" class="form-control" id="exampleusuario" name="username"
          aria-describedby="emailHelp">

      </div>
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label title">Contraseña:</label>
