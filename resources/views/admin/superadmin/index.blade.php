...
<body>
  ...
  <nav style="background-color: #1F1F29" class="navbar navbar-expand-lg">
    <div class="container">
      ...
      <div class="mx-auto">
        <h1 class="navbar-text title">Superadmin</h1>
      </div>
  ...
  <div class="d-flex gap-2 px-4 py-2">
    <div>
      <a href={{ route('allEquiposMantenimiento') }} class="btn btn-light">Ver todos los equipos en mantenimiento</a>
    </div>
    <div>
      <a href={{ route('allClientes') }} class="btn btn-light">Ver todos los clientes</a>
    </div>
    @if ($isSearch)
      <div>
        <a href={{ route('superadmin') }} class="btn btn-light">Ver a todos los tecnicos</a>
      </div>
    @endif
  </div>
            ...
            <div class="card" style="width: 17vw;">
              <div class="card-body">
                ...
                <div class="row gy-1">
                  ...
                  <div class="col">
                    <a href={{ route('mantenimientoTecnicoforspecific', ['id' => $item->id]) }}
