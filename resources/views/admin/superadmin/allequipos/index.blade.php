...
<body>
  ...
  <div class="form-group">
    ...
    <input type="search" id="searchinput" name="search" class="form-control rounded" placeholder="Search"
  ...
  <div id="noresult">
    ...
    <a href={{ route('allEquiposMantenimiento', ['finish' => 1, 'all' => 0]) }} class="btn btn-primary">Ver los equipos
      terminados</a>
    <a href={{ route('allEquiposMantenimiento', ['finish' => 0, 'all' => 1]) }} class="btn btn-primary">Ver los equipos en
      proceso</a>
  </div>
